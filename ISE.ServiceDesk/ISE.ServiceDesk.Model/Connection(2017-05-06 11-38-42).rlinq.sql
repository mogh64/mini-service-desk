...
CREATE TABLE "OBJECTTYPE" (
    "SIZEABLEDESC" NVARCHAR2(100) NULL,     -- _sizeabledesc
    "SIZEABLE" NUMBER(1) NULL,              -- _sizeable
    "OBJECTTYPE_ID" NUMBER(5) NOT NULL,     -- _objecttypeid
    "OBJECTTYPE_DESC" NVARCHAR2(100) NOT NULL, -- _objecttypedesc
    "DENUMERABLE" NUMBER(1) NULL,           -- _denumerable
    "DELIVERABLE" NUMBER(5) NOT NULL,       -- _deliverable
    CONSTRAINT "pk_OBJECTTYPE" PRIMARY KEY ("OBJECTTYPE_ID")
);

-- ISE.ServiceDesk.Model.SdAttachment
CREATE TABLE "SD_ATTACHMENT" (
    "FILETYPE" VARCHAR2(5) NULL,            -- _filetype
    "FILENAME" VARCHAR2(250) NULL,          -- _filename
    "DESCRIPTION" VARCHAR2(250) NULL,       -- _description
    "CONTENT" BLOB NULL,                    -- _content
    "ATTACHMENT_ID" NUMBER(6) NOT NULL,     -- _attachmentid
    CONSTRAINT "pk_SD_ATTACHMENT" PRIMARY KEY ("ATTACHMENT_ID")
);
